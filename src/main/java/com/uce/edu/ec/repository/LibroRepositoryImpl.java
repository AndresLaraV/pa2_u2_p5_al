...
public class LibroRepositoryImpl implements ILibroRepository {
	...
	public List<Libro> seleccionarPorFechaPublicacion(LocalDateTime fechaPublicacion) {
		// TODO Auto-generated method stub
		// SQL: Select * FROM libro l WHERE l.lbro_fecha_publicacion >=?
	...
	public Libro seleccionarPorNombre(String nombre) {
		...
		// JPQL: SELECT l FROM Libro l WHERE l.titulo = :variable AND l.fecha =:
		// variable2
	...
	public List<Libro> seleccionarPorFecha(LocalDateTime fechaPublicacion) {
		// TODO Auto-generated method stub
		TypedQuery<Libro> myQuery = this.entityManager.createQuery("SELECT l FROM Libro l WHERE l.titulo = :fecha",
				Libro.class);
		myQuery.setParameter("fecha", fechaPublicacion);
